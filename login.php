...
<!--
 __________________________________________________ Start Content -->
						<section id="middle_content">
							<form method="post" name="contactForm" action="login_db.php" enctype="multipart/form-data">
                                
                                <table align="center" width="200" style="padding:30px;">
									<tr>
										<td tyle=" padding:30px;"><label style="width:200px;">User Name *</label></td>
										<td style=" padding:30px;"><input type="text" name="uid" style="border:1px #000000 solid; padding:5px;"/></td>
									</tr>
									<tr>
										<td style=" padding:30px;"><label style="width:200px;">Password *</label></td>
										<td style=" padding:30px;"><input type="password" name="pass" style="border:1px #000000 solid; padding:5px;"/></td>
									</tr>
									<tr>
